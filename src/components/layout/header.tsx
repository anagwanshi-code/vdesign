        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 md:px-12">
          ...
          <div className="hidden h-20 min-w-0 items-stretch gap-4 md:grid md:grid-cols-[minmax(0,1fr)_minmax(0,2fr)_minmax(0,1fr)] md:items-center lg:h-24 lg:gap-6">
            ...
            <div className="flex min-w-0 flex-1 items-center justify-end gap-3 lg:gap-4">
              <Link
                href="/consultation"
                className="inline-flex shrink-0 items-center justify-center rounded-full bg-pink-600 bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2.5 text-xs font-medium leading-none text-white shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl lg:px-6 lg:text-sm"
              >
                Book Consultation
              </Link>
              <ShopLinkButton />
          ...
          <>
            ...
            >
              ...
              <Link
                href="/consultation"
                onClick={closeMobileMenu}
                className="mt-8 inline-flex items-center justify-center rounded-full bg-pink-600 bg-gradient-to-r from-pink-500 to-rose-500 px-6 py-3 text-sm font-medium text-white shadow-md"
              >
                Book Consultation
              </Link>
            </motion.nav>
